...
declare -A MODEL_CONFIGS=(
    ["Pixart-alpha"]="pixartalpha_example.py ./checkpoints/PixArt-XL-2-1024-MS 20"
    ["Pixart-sigma"]="pixartsigma_example.py ./checkpoints/PixArt-Sigma-XL-2-2K-MS 20"
    ["Sd3"]="sd3_example.py ./checkpoints//stable-diffusion-3-medium-diffusers 20"
    ["Flux"]="flux_example.py ./checkpoints/flux___1-schnell 28"
    ["HunyuanDiT"]="hunyuandit_example.py ./checkpoints/HunyuanDiT-v1.2-Diffusers 50"
)
