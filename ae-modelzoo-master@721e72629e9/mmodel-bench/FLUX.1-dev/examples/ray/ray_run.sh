...
declare -A MODEL_CONFIGS=(
    ["Sd3"]="ray_sd3_example.py ./checkpoints//stable-diffusion-3-medium-diffusers 20"
    ["Flux"]="ray_flux_example.py ./checkpoints/flux___1-schnell 28"
)
echo ${MODEL_CONFIGS[$MODEL_TYPE]}

if [[ -n MODEL_CONFIGS[$MODEL_TYPE] ]]; then
